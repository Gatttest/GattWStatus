...
class ViewPagerAdepterForRecent extends PagerAdapter {

    private Context mContext;
    private LayoutInflater mLayoutInflater;
    private ArrayList<String> mFileArray;

    ViewPagerAdepterForRecent(Context context, ArrayList<String> FileArray) {
        mContext = context;
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        View itemView = mLayoutInflater.inflate(R.layout.viewpager_item_for_recents, container, false);
